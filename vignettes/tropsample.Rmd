...
This note is wrote for showing how to use R code implementing MCMC method in tropical space. All the code included in this note could be found on https://github.com/QiwenKang/tropicalMCMC.git.
...
outgp = c("Leucoraja","Scyliorhin","Callorhinc"))
